class Spree::AdvancedReport::LocalTaxOrderReport < Spree::AdvancedReport
  ...
  def initialize(params)
    ...
    params[:advanced_reporting][:order_type] = 'complete' if params[:advanced_reporting][:order_type].blank?

    # default to exclude orders that are not fully shipped
    params[:advanced_reporting][:shipment] = 'none' if params[:advanced_reporting][:shipment].blank?
